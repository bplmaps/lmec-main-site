...
content_block:
  - content_block_header: 'In-Person: Creating a Map Icon Library for the City · June 17, 2 pm ET'
    content_block_text: >
      ...
      icon libraries. We will then turn to a hands-on activity where we will
      iteratively create icons for the city that better reflect our experiences
      of places. This icon set will be publicly available to mapmakers and
  ...
  - content_block_header: 'Spotlight: New Digital Collections in ARGO'
    content_block_text: >
      ...
      [First American West digital
      exhibition](https://filsonhistorical.omeka.net/first-american-west), an
      online collection of letters, financial records, sermons, books, maps, and
      objects relating to the Ohio River Valley in the mid-1700s through the
      early 1800s.

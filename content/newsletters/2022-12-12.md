...
- content_block_header: Noisy Data and Noise Pollution
  content_block_text: 'Boston is a particularly noisy place, as [WGBH reported in
    ...
    unpacks [this bivariate map](https://lmec-main-website-staging.netlify.app/uploads/noisepop.png)
    to determine where the noisiest noise intersects with the most people (and vice
    versa). '

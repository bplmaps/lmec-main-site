...
content_block:
  - content_block_header: Summer 2024 Atlascope Tours
    content_block_text: >
      ...
      Leventhal Center to create new layers for
      [Atlascope](https://www.atlascope.org/) by geotransforming digitized
      atlases and expanding the current range of cities and towns available to
      the public.
      ...
      *After Hawthorne’s Salem* and *Beyond the Boulevard*.
  ...
  - content_block_header: 'Time Travel Back to 1906 Boston '
    content_block_text: >
      ...
      how different it looked and functioned over century ago. In this two-part
      article series, friend of the Center, **Gerald A. Rosenthal**, explores
      the history and infrastructure of Boston in 1906 and also uses the 1906
      film *Seeing Boston* to provide a detailed tour by trolley car through the
      city.


      Interested in historic Boston? Take a look at this curated [*From The
      Vault* collections
      showing](https://www.leventhalmap.org/articles/highlights-from-the-vault-time-travel-back-to-1906-boston/)
      organized around the 1906 *Seeing Boston* film.
  ...
  - content_block_header: 'Newsletter Trivia: Feats of 1800s Engineering'
    content_block_text: >
      ...
      receiving three free months in our [Map of the
      Month](https://www.leventhalmap.org/donate/map-of-the-month/) Club. In
      order to enter, make sure you follow us on
      ...
      9 am ET. Correct answers will be included in a random draw—**the winner

...
content_block:
  ...
  - content_block_header: 'Explore Boston''s History with the Walk to the Sea '
    content_block_text: >
      ...
      (and recently relaunched!) [Walk to the
      Sea](https://www.walktothesea.org/) self-guided walking tour. From Beacon
      Hill to Long Wharf, the Walk passes historic monuments and skyscrapers
      with markers running through downtown to learn how Boston’s spaces have
      changed over time.

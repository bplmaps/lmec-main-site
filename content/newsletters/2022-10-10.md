...
- content_block_header: Planning for a Resilient Future
  content_block_text: "We would like to congratulate our friends at [CREW](https://www.climatecrew.org/)
    for organizing a ______ Climate Preparedness Week! We heard from historians, policy
    makers, and community groups on the past, present, and future of climate resilience
    planning. In case you missed it, our conversation about the [challenges of communicating
    climate risks](https://www.leventhalmap.org/event/communicating-climate-risk/)
    is now available to view on YouTube, featuring a behind-the-scenes look at \n\non
    the challenges of communicating climate risks is available to view on our YouTube
    channel, featuing \n\nFor more from CREW, check out their recently-released [study
    on extreme weather and social connectedness](https://www.climatecrew.org/tufts_social_study)
    with [Tufts UEP](https://as.tufts.edu/uep/). "

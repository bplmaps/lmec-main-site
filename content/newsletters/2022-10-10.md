...
- content_block_header: Planning for a Resilient Future
  content_block_text: 'We would like to congratulate our friends at [CREW](https://www.climatecrew.org/)
    for organizing a ______ Climate Preparedness Week! We heard from [historians](https://www.leventhalmap.org/event/ground-truth-shaping-narratives-of-environmental-justice/),
    [policy makers](https://www.leventhalmap.org/event/communicating-climate-risk/),
    and community groups on the past, present, and future of climate resilience planning.
    For more from CREW, check out their recently-released [study on extreme weather
    and social connectedness](https://www.climatecrew.org/tufts_social_study) with
    [Tufts UEP](https://as.tufts.edu/uep/). '

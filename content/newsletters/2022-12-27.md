...
- content_block_text: 'After ten months on display and tens of thousands of visitors,
    it has come time to close the doors on _More or Less in Common: Environment and
    Justice in the Human Landscape_. For folks in Boston, we invite you to visit one
    last time before December 29, but for those unable to make it, the companion [digital

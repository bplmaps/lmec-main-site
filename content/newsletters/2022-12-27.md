...
- content_block_text: 'As we move into the new year, we are eager to unveil a new
    set up in our gallery space: two exhibitions instead of one! In addition to a
    rotating show, we are thrilled to announce the addition of a permanent exhibition,
  ...
  content_block_button_text: Preview the exhibitions

...
- content_block_header: 'Awarded "Most Viewed" for 2022 '
  content_block_text: 'The results are in! This 1886 [map](https://collections.leventhalmap.org/search/commonwealth:x633f896s)
    ...
    this year. It was once displayed in our [_Journeys of the Imagination_](https://collections.leventhalmap.org/exhibits/17)
    ...
    (2011-2012) exhibitions, and glorifies the late-19th-century British Empire through
    color and decorative design (and a Mercator projection centered on the Greenwich
    Prime Meridian places Great Britain just above the map''s central focal point). '
  content_block_button_url: Learn about the map
  content_block_button_text: https://collections.leventhalmap.org/search/commonwealth:x633f896s

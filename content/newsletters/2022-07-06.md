...
- content_block_header: How did the Japanese state see the world 300 years ago?
  content_block_text: A richly detailed map of the world from Edo period Japan is the subject of the latest [Map Chat](https://www.leventhalmap.org/tags/map-chat/) from the MacLean Collection.
    Follow along with the interactive story as Elke Papelitzky discusses what we can learn about how this map (and its changes, censorship, and revisions over time)
    tracked changes in Japan's place in the world at that time.
...
- content_block_header: A welcome to our newest team member
  content_block_text: We love summer because it means our offices are
    a little bit more full with summer interns and new staff—and this year is no exception!
    We sat down with Kyler, a summer [Seevak Fellow](http://www.learntoquestion.org/class/fellowship/)
    from the Boston Latin School, to hear about what he's excited about in the months ahead
    at the Map Center.
...
- content_block_header: Growing our collections in the history of computer cartography
  content_block_text: The Map Center is soliciting collections donations in the area
    ...
    about two collections that we've recently acquired that illustrate this exciting new collecting area for us.
    (And, if you have an interest in GIS, sign up for our _slightly_ nerdier,

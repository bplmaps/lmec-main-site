  ...
  - content_block_header: 'Gallery Feature: FTV Roundup of July '
    content_block_text: >
      *From The Vault* is a biweekly event series featuring collections objects
      ...
      Revolution" and "Functional Advertisements". These events featured a
      diverse group of maps (some of which our staff had never seen in person
      before!), so we invite you to take a look at what we pulled from the

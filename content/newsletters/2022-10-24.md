...
- content_block_header: Sacrifice Zones and Storage on the Boston-Revere Border
  content_block_text: 'In the coming years, the 44-acre oil tank farm along Route
    ...
    Trident Logistics Center. Though developers describe the project as the "best
    use for the property," logic centers ofter erode the vitality of a neighborhood,
    while concurrently polluting it with fumes and the rattle of engines. In her recent

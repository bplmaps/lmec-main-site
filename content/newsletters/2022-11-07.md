...
- content_block_header: How well do you know your Massachusetts towns?
  ...
  content_block_button_url: leventhalmap.org/articles/town-challenge/
...
- content_block_header: 'Virtual: Small Bites — World Maps Over Time · Nov 17, 3:30pm
    ET '
  content_block_text: " Join Map Center educators during Geography Awareness Week
    to try out one of our most popular lessons for middle school grades. We'll explore
    key concepts such as perspective, audience, and purpose through world maps that
    span the centuries and include thematic maps as well as more unusual examples
    such as a cartogram showing world population. And on November 14, join [#sschat](https://twitter.com/search?q=%23sschat&src=typed_query)
    on Twitter for an evening focused on maps and social justice. "

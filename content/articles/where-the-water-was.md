...
Even as early at 1722, colonists had started to {{<popup src="https://iiif.digitalcommonwealth.org/iiif/2/commonwealth:8k71nt56d/2153,1006,1449,1300/full/0/default.jpg">}}change the outline of Boston {{</popup>}}. They built wharves into the harbor and created a mill dam over the northern inlet. By the turn of the 19th century, Boston's landfilling project had changed the shape of the coastline almost in its entirety. Neighborhood like the Back Bay, South Bay, Seaport, and large sections of downtown are all part of the filled-in territory.
...
This much more modern map of Boston uses a sattelite image as a base. On top, it overlays the city's landfill in three sections: the original land, land added before 1880 and land added after - up until the base photo was taken. You can see that some of the last areas to be filled in were the [airport](https://www.leventhalmap.org/articles/olmsted-to-airport-east-boston-and-urban-development), the Seaport, and South bay.

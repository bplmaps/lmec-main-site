...
---
In our current exhibition, [_More or Less in Common: Environment and Justice in the Human Landscape_](https://www.leventhalmap.org/digital-exhibitions/more-or-less-in-common), we explore the impact of oil at a number of scales and geographies, and look at the role of maps in telling parts of this story. Oil and its production are inherently intertwined with environmental justice and the natural landscape, fostering negative consequences on people and the surrounding environment from the ground to the gas pump: from increased CO2 emissions to oil spills, air pollution and dangerous working conditions. These effects are often unequally distributed between people, just like access to the natural environment.

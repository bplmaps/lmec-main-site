...
![A map of the boston's golden semicircular route Description automatically generated](media/image1.png){width="3.0878762029746283in" height="2.6900153105861766in"}

([https://drive.google.com/file/d/1DmQIaC3EtKd5KUCoF770BVZKXIaoNd52/view?usp=sharing](https://drive.google.com/file/d/1DmQIaC3EtKd5KUCoF770BVZKXIaoNd52/view?usp=sharing))
...
![575 Technology Square](media/image2.jpeg){width="5.09918416447944in" height="6.268292869641295in"}

([https://www.digitalcommonwealth.org/search/commonwealth:wd3778189](https://www.digitalcommonwealth.org/search/commonwealth:wd3778189))

Many Bostonians know that NASA built an Electronics Research Center (ERC) in Kendall Square in the 1960s. It has been (incorrectly) rumored NASA planned to build Mission Control there: according to the story, if not for the intervention of Texan Lyndon Johnson, it would have been "Boston," not "Houston, we have a problem!"\[^14]
...
![KSURA black and white aerial](media/image3.jpeg){width="6.5in" height="5.225694444444445in"}

(https://www.digitalcommonwealth.org/search/commonwealth:1c18gz05k)

Not only would the NASA center bring high-paying jobs to Cambridge directly, but building the ERC was intended to spur private commercial development in what later came to be known as the "golden triangle" directly to the south of the project area. Development of this area would supposedly more than offset the fiscal loss from removing the NASA parcels from Cambridge's tax rolls.\[^15] Boston, too, made overtures to NASA to site the ERC.\[^16]

![A model of the NASA complex that is to be build in the Kendall Sq. section of Cambridge](media/image4.jpeg){width="4.497777777777777in" height="6.016259842519685in"}

(Original: [https://www.digitalcommonwealth.org/search/commonwealth:wd377626k](https://www.digitalcommonwealth.org/search/commonwealth:wd377626k))

![Model shows first phase of planned building construction at NASA's Electronics Research Center, Kendall Square, Cambridge](media/image5.jpeg){width="6.5in" height="5.270138888888889in"}

(Downsized: [https://www.digitalcommonwealth.org/search/commonwealth:wd377610p](https://www.digitalcommonwealth.org/search/commonwealth:wd377610p))

Although the ERC was supposed to be built in phases, the first phase was not even completed as planned. Starting in 1968, the spigot of funds for building the center was closed. After three consecutive years without available construction funding, in late 1969 NASA announced it would close the partially built ERC altogether.\[^17] Purportedly, this was an act of revenge by President Nixon against the state of Massachusetts, another rumor that is difficult to prove or disprove.\[^18]

![NASA employees leave meeting after announcement that their jobs are being phased out in closing of Cambridge NASA Electronics Research Center](media/image6.jpeg){width="6.5in" height="5.803472222222222in"}

(https://www.digitalcommonwealth.org/search/commonwealth:zs25z5009)
...
![An aerial view of a city Description automatically generated](media/image7.jpeg){width="3.4348523622047242in" height="4.577235345581802in"}

https://commons.wikimedia.org/wiki/File:NYCRR\_Headlights\_Cover\_196502XX.png
...
![Relationship of TNEMC development plan area to New York streets land assembly and redevelopment project](media/image8.jpeg){width="2.464879702537183in" height="2.682926509186352in"}

(https://www.digitalcommonwealth.org/search/commonwealth:ks65kv52b)
...
![Student addressing crowd during rally in support of SDS members at Harvard](media/image9.jpeg){width="4.9674792213473316in" height="4.2154582239720035in"}

(https://www.digitalcommonwealth.org/search/commonwealth:s1785g993)

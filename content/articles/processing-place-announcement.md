...
When data becomes too big for people to comprehend, we turn to computers for help. Mapping millions, billions, or even *[trillions](https://www.washingtonpost.com/news/energy-environment/wp/2015/09/16/the-countries-of-the-world-ranked-by-their-tree-wealth/)* of trees simply wouldn't be possibly without computers to help us process the information. That's how organizations like [Speak for the Trees, Boston](https://treeboston.org/) made their series of [tree equity maps](https://treeboston.org/tree-equity-maps/), which visualize the relationships between tree canopy, urban heat, and other social and environmental factors (American Forest has made a version with [national coverage](https://www.treeequityscore.org/map#8.49/42.3446/-71.4349)). Today, from [tree equity](https://www.treeequityscore.org/map#8.49/42.3446/-71.4349) to [Atlascope](https://atlascope.org), computers are fundamental parts of the mapmaking process. We're used to maps that move, maps that flow seamlessly and infinitely on a screen, but it's worth pausing to ask: how did we get here? Just how, exactly, did the computer become a cartographer?

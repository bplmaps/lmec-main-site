...
The ability to recombine maps with spatial data---to perform calculations and tell spatial stories from them---began to distinguish computer-aided mapping from its analog predecessors. And cutting-edge though such methods were back then, they seem positively quaint compared to the wide range of dynamic, location-aware, and continuously connected **geographic information systems** (GIS, for short) that now span the full gamut of our everyday lives.

September 2024 will kick off the Leventhal Center's exhibition on the rise of digital mapping, ***Processing Place: How Computers and Cartographers Redrew our World***. In *Processing Place*, we look closely at the projects, products, and processes that people used to "[compute space](https://blogs.loc.gov/maps/2015/11/saving-early-computer-cartography/)," especially from 1960 onward. While physical maps from this time period are often overlooked in favor of their more [antiquarian counterparts](https://collections.leventhalmap.org/search/commonwealth:x633fb17j), we'll show how pairing older maps with newer ones---alongside the geospatial data that derive from them both---can reveal quite a lot about our modern geographic lives.

In part, *Processing Place* examines how digitally-created maps are made by hand no less than maps of centuries past. Take, for example, this digital map of [additions to Boston's shoreline](https://collections.leventhalmap.org/search/commonwealth:q524n4326) between 1795 and 1995. Lacking a time machine, the mapmakers did not go out and survey the historic shoreline themselves, but they weren't just making educated guesses to produce their map, either: they created the map by digitally tracing, among other objects, Osgood Carleton's 1796 [*Plan of Boston*](https://collections.leventhalmap.org/search/commonwealth:x633f8530).

<!-- {{ nantucket MassGIS map -- right }}

The same goes for this [1988 map of Nantucket](https://archives.bpl.org/repositories/2/archival_objects/65956) from the Applied Geographics, Inc. (AppGeo) Records. In this case, the source material for digital land use data was not a historic map, but a series of aerial photographs, at least one of which can be found in [UMass Amherst's extensive aerial photography collections](https://credo.library.umass.edu/view/full/mufs190-1984-4710-i001). -->
...
To hazard a guess, we combined spatial data of the 1630 shoreline (also traced from historic maps) with contemporary parcel data from the City of Boston and arrived at a figure exceeding **$36 billion**. Numbers like that can help put things in perspective regarding how valuable land gets used, who decides, and who benefits from [capitalizing on it](https://www.leventhalmap.org/articles/making-water-into-gold/).

{{<figure src="https://iiif.digitalcommonwealth.org/iiif/2/commonwealth:00000x72t/full/1200,/0/default.jpg"  caption="[Tax parcels that would have been underwater in 1630](https://collections.leventhalmap.org/search/commonwealth:00000x71j)." class="figure-center">}}

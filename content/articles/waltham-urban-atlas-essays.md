...
{{< figure src="/images/blog/walthamEssays/goldsteinIMAGE06.jpg" caption="Section of Waltham Master Plan describing eminent domain use in the Whitney Avenue area (from Waltham Public Library) " class="figure-center" >}}
...
Eventually, the shrinking service was [incorporated into the MBTA's Commuter Rail](https://www.leventhalmap.org/digital-exhibitions/getting-around-town/topics/a-period-of-newness/) in 1959. Over the next decade, the line continued to be plagued by low ridership problems. The rising use of cars, and more importantly, car-based infrastructure, were a significant reason why ridership remained low. As new highways were being built, [fewer and fewer people](https://www.wickedlocal.com/story/weston-town-crier/2013/06/18/weston-chronicles-saga-central-mass/40752184007/) were choosing to use mass transit.
...
As the [georeferenced](https://www.leventhalmap.org/projects/digital-projects/georeferencing/) map below highlights, the lasting impact of immigration patterns on the infrastructure and organization of the city are still visible in the Moody Street landscape. The{{<popup img-src="/images/blog/walthamEssays/ruizImage7.png">}}Beth Eden Baptist Church,{{</popup>}}for example, was first built in 1891 and still stands tall on Maple Street in Waltham's South Side.
